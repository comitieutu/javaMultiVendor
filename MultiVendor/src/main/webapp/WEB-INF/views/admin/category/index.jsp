...
<h3>
	<i class="fa fa-angle-right"></i> All category
</h3>
<div class="row mt">
	<div class="col-md-12">
				...
				<tbody>
					<c:forEach var="c" items="${categories }">
						<tr>
							...
							<td>${c.description }</td>
							<td>${c.parent}</td>
							<td><c:set var="isDeleteAble"
									value="${fn:length(c.products) == 0 && c.parent != 0}"></c:set>
								<a
								href="${pageContext.request.contextPath }/admin/category/update/${c.id}"
