                    ...
                    <ul class="nav-top">
                        <li class="level1"><a href="#" title="Hopme">Home</a>
                            <ul class="menu-level-1">
                                <li class="level2"><a href="home_v1.html" tppabs="http://landing.engocreative.com/html/dama/demo/home_v1.html" title="Home 1" target="_blank">Home</a></li>
                                <li class="level2"><a href="about.html" tppabs="http://landing.engocreative.com/html/dama/demo/about.html" title="Home 2" target="_blank">About us</a></li>
                                <li class="level2"><a href="contact.html" tppabs="http://landing.engocreative.com/html/dama/demo/contact.html" title="Home 3" target="_blank">Contact us</a></li>
                            </ul>
                        </li>
                    ...
                    <li class="level1 dropdown">
                        ...
                        <div class="sub-menu dropdown-menu">
                            <ul class="menu-level-1">
                                ...
                                <li class="level2">
                                    <img src="assets/images/images-menu.jpg" tppabs="http://landing.engocreative.com/html/dama/demo/assets/images/images-menu.jpg" alt="Sub-Menu" />
                                </li>
                            </ul>
                        </div>
                        <!-- End Dropdow Menu -->
    ...
    <nav class="menu-mobile">
        <ul class="nav">
            <li class="level1"><a href="#" title="Store">Store</a>
                <ul class="menu-level-1">
                    <li class="level2"><a href="home_v1.html" tppabs="http://landing.engocreative.com/html/dama/demo/home_v1.html" title="Home" target="_blank">Home</a></li>
                    <li class="level2"><a href="home_v2.html" tppabs="http://landing.engocreative.com/html/dama/demo/home_v2.html" title="about us" target="_blank">about us</a></li>
                    <li class="level2"><a href="home_v3.html" tppabs="http://landing.engocreative.com/html/dama/demo/home_v3.html" title="contatc us" target="_blank">contatc us</a></li>
                </ul>
            </li>
            <li class="level1"><a href="#" title="Product">Product</a>
                <ul class="menu-level-1">
            ...
            <li class="level1"><a href="#" title="Headphone">Headphone</a>
                <ul class="menu-level-1">
                    <li class="level2"><a href="home_v1.html" tppabs="http://landing.engocreative.com/html/dama/demo/home_v1.html" title="Home 1" target="_blank">Headphone 1</a></li>
                    <li class="level2"><a href="home_v2.html" tppabs="http://landing.engocreative.com/html/dama/demo/home_v2.html" title="Home 2" target="_blank">Headphone 2</a></li>
                    <li class="level2"><a href="home_v3.html" tppabs="http://landing.engocreative.com/html/dama/demo/home_v3.html" title="Home 3" target="_blank">Headphone 3</a></li>
                    <li class="level2"><a href="javascript:if(confirm(%27http://landing.engocreative.com/html/dama/demo/home_v4.html  \n\nThis file was not retrieved by Teleport Pro, because the server reports that an error occurred that prevented retrieval.  \n\nDo you want to open it from the server?%27))window.location=%27http://landing.engocreative.com/html/dama/demo/home_v4.html%27" tppabs="http://landing.engocreative.com/html/dama/demo/home_v4.html" title="Home 4" target="_blank">Headphone 4</a></li>
                </ul>
            </li>
            <li class="level1">
            ...
            <div class="tp-banner tp-banner-ver1" >
                <ul>
                    ...
                    <li data-transition="notransition" data-slotamount="6" data-masterspeed="1000" >
                        <!-- MAIN IMAGE -->
                        <img src="assets/images/bg-slide-show.png" tppabs="http://landing.engocreative.com/html/dama/demo/assets/images/bg-slide-show.png" alt="bg-slide-show.png"  data-bgfit="cover" data-bgposition="left top" data-bgrepeat="no-repeat">
                        <!-- LAYER NR. 3 -->
                        ...
                        <div class="tp-caption skewfromright customout"
                             ...
                             data-endeasing="Power1.easeIn"
                             data-captionhidden="on"
                             style="z-index: 1"><img src="assets/images/home1-slideshow.png" tppabs="http://landing.engocreative.com/html/dama/demo/assets/images/home1-slideshow.png" alt="galaxy s7">
                        </div>
                    </li>
                    <!-- SLIDER -->
                    <!-- SLIDE  -->
...
<div class="main-content">
    <div class="featured-product slider-product space-padding-tb-80">
        <div class="container">
            <div class="title-text size-64">
                <h3><span>F</span>eatured product</h3>
            </div>
            <div class="images">
                <img src="assets/images/Dana-home1.bg-featured.png" tppabs="http://landing.engocreative.com/html/dama/demo/assets/images/Dana-home1.bg-featured.png" alt="Product-Featured">
            </div>
            <!-- end images -->
            ...
            <div class="products">
                <div class="product">
                    ...
                    <a class="product-images" href="#" title="">
                        <img class="primary_image" src="assets/images/Dana-home1-product-featured1.png" tppabs="http://landing.engocreative.com/html/dama/demo/assets/images/Dana-home1-product-featured1.png" alt="Product"/>
                    </a>
                ...
                <div class="product">
                    <span class="icon-cat headphone"></span>
                    <a class="product-images" href="#" title="">
                        <img class="primary_image" src="assets/images/Dana-home1-product-featured2.png" tppabs="http://landing.engocreative.com/html/dama/demo/assets/images/Dana-home1-product-featured2.png" alt="Product"/>
                    </a>
                    <div class="product-content">
                        <p>Headphone</p>
                        <p class="title"> Beats Pro headphones</p>
                ...
                <div class="product">
                    <span class="icon-cat headphone"></span>
                    <a class="product-images" href="#" title="">
                        <img class="primary_image" src="assets/images/Dana-home1-product-featured3.png" tppabs="http://landing.engocreative.com/html/dama/demo/assets/images/Dana-home1-product-featured3.png" alt="Product"/>
                    </a>
                    <div class="product-content">
                        <p>Headphone</p>
                        <p class="title"> Beats Pro headphones</p>
                ...
                <div class="product">
                    <span class="icon-cat headphone"></span>
                    <a class="product-images" href="#" title="">
                        <img class="primary_image" src="assets/images/Dana-home1-product-featured4.png" tppabs="http://landing.engocreative.com/html/dama/demo/assets/images/Dana-home1-product-featured4.png" alt="Product"/>
                    </a>
                    <div class="product-content">
                        <p>Headphone</p>
                        <p class="title"> Beats Pro headphones</p>
                ...
                <div id="tab_01" class="tab-content">
                    <div class="products">
                                ...
                                <div class="slide-product-images">
                                    <div class="items" data-thumb='<img class="primary_image" src="assets/images/Dana-home1-product1.jpg" alt=""/>'>
                                        <a href="#" title="products">
                                            <img class="primary_image" src="assets/images/Dana-home1-product1.jpg" tppabs="http://landing.engocreative.com/html/dama/demo/assets/images/Dana-home1-product1.jpg" alt=""/>
                                        </a>
                                    </div>
                                    <div class="items" data-thumb='<img class="primary_image" src="assets/images/Dana-home1-product2.jpg" alt=""/>'>
                                        <a href="#" title="products">
                                            <img class="primary_image" src="assets/images/Dana-home1-product2.jpg" tppabs="http://landing.engocreative.com/html/dama/demo/assets/images/Dana-home1-product2.jpg" alt=""/>
                                        </a>
                                    </div>
                                    <div class="items" data-thumb='<img class="primary_image" src="assets/images/Dana-home1-product3.jpg" alt=""/>'>
                                        <a href="#" title="products">
                                            <img class="primary_image" src="assets/images/Dana-home1-product3.jpg" tppabs="http://landing.engocreative.com/html/dama/demo/assets/images/Dana-home1-product3.jpg" alt=""/>
                                        </a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="product">
                            ...
                            <!-- End wrap-title -->
                            <a class="product-images" href="#" title="">
                                <img class="primary_image" src="assets/images/Dana-home1-product4.jpg" tppabs="http://landing.engocreative.com/html/dama/demo/assets/images/Dana-home1-product4.jpg" alt=""/>
                            </a>
                            <div class="action">
                                <a href="#" class="refresh"><i class="zmdi zmdi-refresh-sync"></i></a>
                                <a title="Like" href="#"><i class="zmdi zmdi-favorite-outline"></i></a>
                        ...
                        <div class="product">
                            ...
                            <!-- End wrap-title -->
                            <a class="product-images" href="#" title="">
                                <img class="primary_image" src="assets/images/Dana-home1-product5.jpg" tppabs="http://landing.engocreative.com/html/dama/demo/assets/images/Dana-home1-product5.jpg" alt=""/>
                            </a>
                            <div class="action">
                                <a href="#" class="refresh"><i class="zmdi zmdi-refresh-sync"></i></a>
                                <a title="Like" href="#"><i class="zmdi zmdi-favorite-outline"></i></a>
                        ...
                        <div class="product">
                            ...
                            <!-- End wrap-title -->
                            <a class="product-images" href="#" title="">
                                <img class="primary_image" src="assets/images/products/12.jpg" tppabs="http://landing.engocreative.com/html/dama/demo/assets/images/products/12.jpg" alt=""/>
                            </a>
                            <div class="action">
                                <a href="#" class="refresh"><i class="zmdi zmdi-refresh-sync"></i></a>
                                <a title="Like" href="#"><i class="zmdi zmdi-favorite-outline"></i></a>
                        ...
                        <div class="product">
                            ...
                            <!-- End wrap-title -->
                            <a class="product-images" href="#" title="">
                                <img class="primary_image" src="assets/images/products/9.jpg" tppabs="http://landing.engocreative.com/html/dama/demo/assets/images/products/9.jpg" alt=""/>
                            </a>
                            <div class="action">
                                <a href="#" class="refresh"><i class="zmdi zmdi-refresh-sync"></i></a>
                                <a title="Like" href="#"><i class="zmdi zmdi-favorite-outline"></i></a>
                ...
                <div id="tab_02" class="tab-content">
                    <div class="products">
                        <div class="product">
                            ...
                            <div class="product-images">
                                <div class="slide-product-images">
                                    <div class="items" data-thumb='<img class="primary_image" src="assets/images/products/5.jpg" alt=""/>'>
                                        <a href="#" title="products">
                                            <img class="primary_image" src="assets/images/products/5.jpg" tppabs="http://landing.engocreative.com/html/dama/demo/assets/images/products/5.jpg" alt=""/>
                                        </a>
                                    </div>
                                    <div class="items" data-thumb='<img class="primary_image" src="assets/images/products/6.jpg" alt=""/>'>
                                        <a href="#" title="products">
                                            <img class="primary_image" src="assets/images/products/6.jpg" tppabs="http://landing.engocreative.com/html/dama/demo/assets/images/products/6.jpg" alt=""/>
                                        </a>
                                    </div>
                                    <div class="items" data-thumb='<img class="primary_image" src="assets/images/products/7.jpg" alt=""/>'>
                                        <a href="#" title="products">
                                            <img class="primary_image" src="assets/images/products/7.jpg" tppabs="http://landing.engocreative.com/html/dama/demo/assets/images/products/7.jpg" alt=""/>
                                        </a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="product">
                            ...
                            <!-- End wrap-title -->
                            <a class="product-images" href="#" title="">
                                <img class="primary_image" src="assets/images/Dana-home1-product6.jpg" tppabs="http://landing.engocreative.com/html/dama/demo/assets/images/Dana-home1-product6.jpg" alt=""/>
                            </a>
                            <div class="action">
                                <a href="#" class="refresh"><i class="zmdi zmdi-refresh-sync"></i></a>
                                <a title="Like" href="#"><i class="zmdi zmdi-favorite-outline"></i></a>
                ...
                <div id="tab_03" class="tab-content">
                    <div class="products">
                        <div class="product">
                            ...
                            <div class="product-images">
                                <div class="slide-product-images">
                                    <div class="items" data-thumb='<img class="primary_image" src="assets/images/products/4.jpg" alt=""/>'>
                                        <a href="#" title="products">
                                            <img class="primary_image" src="assets/images/products/4.jpg" tppabs="http://landing.engocreative.com/html/dama/demo/assets/images/products/4.jpg" alt=""/>
                                        </a>
                                    </div>
                                    <div class="items" data-thumb='<img class="primary_image" src="assets/images/products/5.jpg" alt=""/>'>
                                        <a href="#" title="products">
                            ...
                            <div class="product-images">
                                <div class="slide-product-images">
                                    <div class="items" data-thumb='<img class="primary_image" src="assets/images/products/1.jpg" alt=""/>'>
                                        <a href="#" title="products">
                                            <img class="primary_image" src="assets/images/products/1.jpg" tppabs="http://landing.engocreative.com/html/dama/demo/assets/images/products/1.jpg" alt=""/>
                                        </a>
                                    </div>
                                    <div class="items" data-thumb='<img class="primary_image" src="assets/images/products/6.jpg" alt=""/>'>
                                        <a href="#" title="products">
                ...
                <div id="tab_05" class="tab-content">
                    <div class="products">
                        <div class="product">
                            ...
                            <div class="product-images">
                                <div class="slide-product-images">
                                    <div class="items" data-thumb='<img class="primary_image" src="assets/images/products/11.jpg" alt=""/>'>
                                        <a href="#" title="products">
                                            <img class="primary_image" src="assets/images/products/11.jpg" tppabs="http://landing.engocreative.com/html/dama/demo/assets/images/products/11.jpg" alt=""/>
                                        </a>
                                    </div>
                                    <div class="items" data-thumb='<img class="primary_image" src="assets/images/products/6.jpg" alt=""/>'>
                                        <a href="#" title="products">
                ...
                <div id="tab_06" class="tab-content">
                    <div class="products">
                        <div class="product">
                            ...
                            <div class="product-images">
                                <div class="slide-product-images">
                                    <div class="items" data-thumb='<img class="primary_image" src="assets/images/products/9.jpg" alt=""/>'>
                                        <a href="#" title="products">
                                            <img class="primary_image" src="assets/images/products/9.jpg" tppabs="http://landing.engocreative.com/html/dama/demo/assets/images/products/9.jpg" alt=""/>
                                        </a>
                                    </div>
    ...
    <div class="banner-home1-bottom">
        <div class="container">
            <div class="images">
                <img src="assets/images/Dana-home1-banner-bottom.png" tppabs="http://landing.engocreative.com/html/dama/demo/assets/images/Dana-home1-banner-bottom.png" alt="Banner">
            </div>
            <!-- End image -->
            <div class="text">
    ...
    <div class="best-sellers slider-product tabs-right space-padding-tb-60">
        <div class="container">
            <div class="title-text">
                    ...
                    <div class="slide-product-tab">
                        <div class="products">
                            <div class="product">
                                ...
                                <div class="product-images">
                                    <div class="slide-product-images">
                                        <div class="items" data-thumb='<img class="primary_image" src="assets/images/products/1.png" alt=""/>'>
                                            <a href="#" title="products">
                                                <img class="primary_image" src="assets/images/products/1.png" tppabs="http://landing.engocreative.com/html/dama/demo/assets/images/products/1.png" alt=""/>
                                            </a>
                                        </div>
                                        <div class="items" data-thumb='<img class="primary_image" src="assets/images/Dana-home1-product2.jpg" alt=""/>'>
                                            <a href="#" title="products">
                            ...
                            <div class="product">
                                ...
                                <!-- End wrap-title -->
                                <a class="product-images" href="#" title="">
                                    <img class="primary_image" src="assets/images/products/22.jpg" tppabs="http://landing.engocreative.com/html/dama/demo/assets/images/products/22.jpg" alt=""/>
                                </a>
                                <div class="action">
                                    <a href="#" class="refresh"><i class="zmdi zmdi-refresh-sync"></i></a>
                                    <a title="Like" href="#"><i class="zmdi zmdi-favorite-outline"></i></a>
                            ...
                            <div class="product">
                                ...
                                <!-- End wrap-title -->
                                <a class="product-images" href="#" title="">
                                    <img class="primary_image" src="assets/images/products/3.jpg" tppabs="http://landing.engocreative.com/html/dama/demo/assets/images/products/3.jpg" alt=""/>
                                </a>
                                <div class="action">
                                    <a href="#" class="refresh"><i class="zmdi zmdi-refresh-sync"></i></a>
                                    <a title="Like" href="#"><i class="zmdi zmdi-favorite-outline"></i></a>
                            ...
                            <div class="product">
                                ...
                                <!-- End wrap-title -->
                                <a class="product-images" href="#" title="">
                                    <img class="primary_image" src="assets/images/products/16.jpg" tppabs="http://landing.engocreative.com/html/dama/demo/assets/images/products/16.jpg" alt=""/>
                                </a>
                                <div class="action">
                                    <a href="#" class="refresh"><i class="zmdi zmdi-refresh-sync"></i></a>
                                    <a title="Like" href="#"><i class="zmdi zmdi-favorite-outline"></i></a>
                            ...
                            <div class="product">
                                ...
                                <div class="product-images">
                                    <div class="slide-product-images">
                                        ...
                                        <div class="items" data-thumb='<img class="primary_image" src="assets/images/products/2.jpg" alt=""/>'>
                                            <a href="#" title="products">
                                                <img class="primary_image" src="assets/images/products/2.jpg" tppabs="http://landing.engocreative.com/html/dama/demo/assets/images/products/2.jpg" alt=""/>
                                            </a>
                                        </div>
                                        <div class="items" data-thumb='<img class="primary_image" src="assets/images/products/3.jpg" alt=""/>'>
                                            <a href="#" title="products">
                                                <img class="primary_image" src="assets/images/products/3.jpg" tppabs="http://landing.engocreative.com/html/dama/demo/assets/images/products/3.jpg" alt=""/>
                                            </a>
                                        </div>
                            ...
                            <div class="product">
                                ...
                                <div class="product-images">
                                    <div class="slide-product-images">
                                        ...
                                        <div class="items" data-thumb='<img class="primary_image" src="assets/images/products/2.jpg" alt=""/>'>
                                            <a href="#" title="products">
                                                <img class="primary_image" src="assets/images/products/8.jpg" tppabs="http://landing.engocreative.com/html/dama/demo/assets/images/products/8.jpg" alt=""/>
                                            </a>
                                        </div>
                                        <div class="items" data-thumb='<img class="primary_image" src="assets/images/products/3.jpg" alt=""/>'>
                                            <a href="#" title="products">
                        ...
                        <div class="product">
                            ...
                            <div class="product-images">
                                <div class="slide-product-images">
                                    ...
                                    <div class="items" data-thumb='<img class="primary_image" src="assets/images/products/12.jpg" alt=""/>'>
                                        <a href="#" title="products">
                                            <img class="primary_image" src="assets/images/products/12.jpg" tppabs="http://landing.engocreative.com/html/dama/demo/assets/images/products/12.jpg" alt=""/>
                                        </a>
                                    </div>
                                    <div class="items" data-thumb='<img class="primary_image" src="assets/images/products/13.jpg" alt=""/>'>
                                        <a href="#" title="products">
                                            <img class="primary_image" src="assets/images/products/13.jpg" tppabs="http://landing.engocreative.com/html/dama/demo/assets/images/products/13.jpg" alt=""/>
                                        </a>
                                    </div>
                                </div>
                            </div>
                ...
                <div id="tab1_04" class="tab-content1">
                    <div class="products">
                        <div class="product">
                            ...
                            <div class="product-images">
                                <div class="slide-product-images">
                                    <div class="items" data-thumb='<img class="primary_image" src="assets/images/products/8.jpg" alt=""/>'>
                                        <a href="#" title="products">
                                            <img class="primary_image" src="assets/images/products/8.jpg" tppabs="http://landing.engocreative.com/html/dama/demo/assets/images/products/8.jpg" alt=""/>
                                        </a>
                                    </div>
                                    ...
                                    <div class="items" data-thumb='<img class="primary_image" src="assets/images/products/10.jpg" alt=""/>'>
                                        <a href="#" title="products">
                                            <img class="primary_image" src="assets/images/products/10.jpg" tppabs="http://landing.engocreative.com/html/dama/demo/assets/images/products/10.jpg" alt=""/>
                                        </a>
                                    </div>
                                </div>
                            </div>
...
<div class="bottom-product-footer space-padding-tb-50">
    <div class="container">
        <div class="col-md-4 col-sm-4">
            ...
            <div class="product">
                <a class="product-images" href="#" title="">
                    <img class="primary_image" src="assets/images/products/14.jpg" tppabs="http://landing.engocreative.com/html/dama/demo/assets/images/products/14.jpg" alt=""/>
                </a>
                <div class="product-content">
                    <a class="category" href="#" title="category">watch</a>
            ...
            <div class="product">
                <a class="product-images" href="#" title="">
                    <img class="primary_image" src="assets/images/products/15.jpg" tppabs="http://landing.engocreative.com/html/dama/demo/assets/images/products/15.jpg" alt=""/>
                </a>
                <div class="product-content">
                    <a class="category" href="#" title="category">watch</a>
        ...
        <div class="col-md-4 col-sm-4">
            ...
            <div class="product">
                <a class="product-images" href="#" title="">
                    <img class="primary_image" src="assets/images/products/17.jpg" tppabs="http://landing.engocreative.com/html/dama/demo/assets/images/products/17.jpg" alt=""/>
                </a>
                <div class="product-content">
                    <a class="category" href="#" title="category">watch</a>
            ...
            <div class="product">
                <a class="product-images" href="#" title="">
                    <img class="primary_image" src="assets/images/products/18.jpg" tppabs="http://landing.engocreative.com/html/dama/demo/assets/images/products/18.jpg" alt=""/>
                </a>
                <div class="product-content">
                    <a class="category" href="#" title="category">watch</a>
        ...
        <div class="col-md-4 col-sm-4">
            ...
            <div class="product">
                <a class="product-images" href="#" title="">
                    <img class="primary_image" src="assets/images/products/19.jpg" tppabs="http://landing.engocreative.com/html/dama/demo/assets/images/products/19.jpg" alt=""/>
                </a>
                <div class="product-content">
                    <a class="category" href="#" title="category">watch</a>
            ...
            <div class="product">
                <a class="product-images" href="#" title="">
                    <img class="primary_image" src="assets/images/products/20.jpg" tppabs="http://landing.engocreative.com/html/dama/demo/assets/images/products/20.jpg" alt=""/>
                </a>
                <div class="product-content">
                    <a class="category" href="#" title="category">watch</a>
            ...
            <div class="product">
                <a class="product-images" href="#" title="">
                    <img class="primary_image" src="assets/images/products/21.jpg" tppabs="http://landing.engocreative.com/html/dama/demo/assets/images/products/21.jpg" alt=""/>
                </a>
                <div class="product-content">
                    <a class="category" href="#" title="category">watch</a>
...
<div class="brand-container space-50">
    <div class="container">
        <div class="slider-brand">
            <div class="item">
                <a href="#" title="Brand">
                    <img src="assets/images/Dama-brand1.jpg" tppabs="http://landing.engocreative.com/html/dama/demo/assets/images/Dama-brand1.jpg" alt="Brand">
                </a>
            </div>
            <!-- End item -->
            <div class="item">
                <a href="#" title="Brand">
                    <img src="assets/images/Dama-brand2.jpg" tppabs="http://landing.engocreative.com/html/dama/demo/assets/images/Dama-brand2.jpg" alt="Brand">
                </a>
            </div>
            <!-- End item -->
            <div class="item">
                <a href="#" title="Brand">
                    <img src="assets/images/Dama-brand3.jpg" tppabs="http://landing.engocreative.com/html/dama/demo/assets/images/Dama-brand3.jpg" alt="Brand">
                </a>
            </div>
            <!-- End item -->
            <div class="item">
                <a href="#" title="Brand">
                    <img src="assets/images/Dama-brand4.jpg" tppabs="http://landing.engocreative.com/html/dama/demo/assets/images/Dama-brand4.jpg" alt="Brand">
                </a>
            </div>
            <!-- End item -->
            <div class="item">
                <a href="#" title="Brand">
                    <img src="assets/images/Dama-brand5.jpg" tppabs="http://landing.engocreative.com/html/dama/demo/assets/images/Dama-brand5.jpg" alt="Brand">
                </a>
            </div>
            <!-- End item -->
            <div class="item">
                <a href="#" title="Brand">
                    <img src="assets/images/Dama-brand6.jpg" tppabs="http://landing.engocreative.com/html/dama/demo/assets/images/Dama-brand6.jpg" alt="Brand">
                </a>
            </div>
            <!-- End item -->
        </div>
