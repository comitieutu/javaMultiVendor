...
$(document).ready(function() {
    ...
    if ($("#googleMap2").length) {
        ...
        function initialize() {
            ...
            var mapOptions = {
                ...
                styles: [{
                    "featureType": "all",
                    "elementType": "http://landing.engocreative.com/html/dama/demo/assets/js/labels.text.fill",
                    "stylers": [{
                        "saturation": 36
                    }, {
                        "color": "#000000"
                    ...
                    "featureType": "all",
                    "elementType": "http://landing.engocreative.com/html/dama/demo/assets/js/labels.icon",
                    "stylers": [{
                        "visibility": "off"
                    }]
                }, {
                    "featureType": "administrative",
                    "elementType": "http://landing.engocreative.com/html/dama/demo/assets/js/geometry.fill",
                    "stylers": [{
                        "color": "#000000"
                    }, {
                        "lightness": 20
    ...
    $("form.cart .qtyplus").on("click",function(){
        var currentVal = parseInt($('http://landing.engocreative.com/html/dama/demo/assets/js/form.cart input.qty').val());
        // If is not undefined
        if (!isNaN(currentVal)) {
            // Increment
            $('http://landing.engocreative.com/html/dama/demo/assets/js/form.cart input.qty').val(currentVal + 1);
        } else {
            // Otherwise put a 0 there
            $('http://landing.engocreative.com/html/dama/demo/assets/js/form.cart input.qty').val(1);
        }
    });
