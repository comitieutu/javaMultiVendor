...
<c:set var="path" value="${pageContext.request.contextPath }/resources/admin/client"></c:set>
...
<div class="main-content">
    <div class="featured-product slider-product space-padding-tb-80">
        <div class="container">
            ...
            <div class="images">
                <img src="${path}/images/Dana-home1.bg-featured.png" alt="Product-Featured">
            </div>
            <!-- end images -->
            ...
            <div class="products">
                <div class="product">
                    ...
                    <a class="product-images" href="#" title="">
                        <img class="primary_image" src="${path}/images/Dana-home1-product-featured1.png" alt="Product"/>
                    </a>
                ...
                <div class="product">
                    <span class="icon-cat headphone"></span>
                    <a class="product-images" href="#" title="">
                        <img class="primary_image" src="${path}/images/Dana-home1-product-featured2.png" alt="Product"/>
                    </a>
                    <div class="product-content">
                        <p>Headphone</p>
                        <p class="title"> Beats Pro headphones</p>
                ...
                <div class="product">
                    <span class="icon-cat headphone"></span>
                    <a class="product-images" href="#" title="">
                        <img class="primary_image" src="${path}/images/Dana-home1-product-featured3.png" alt="Product"/>
                    </a>
                    <div class="product-content">
                        <p>Headphone</p>
                        <p class="title"> Beats Pro headphones</p>
                ...
                <div class="product">
                    <span class="icon-cat headphone"></span>
                    <a class="product-images" href="#" title="">
                        <img class="primary_image" src="${path}/images/Dana-home1-product-featured4.png" alt="Product"/>
                    </a>
                    <div class="product-content">
                        <p>Headphone</p>
                        <p class="title"> Beats Pro headphones</p>
    ...
    <div class="banner-home1-bottom">
        <div class="container">
            <div class="images">
                <img src="${path}/images/Dana-home1-banner-bottom.png" alt="Banner">
            </div>
            <!-- End image -->
            <div class="text">
                    ...
                    <div class="slide-product-tab">
                        <div class="products">
                            <div class="product">
                                ...
                                <div class="product-images">
                                    <div class="slide-product-images">
                                        <div class="items" data-thumb='<img class="primary_image" src="${path}/images/products/1.png" alt=""/>'>
                                            <a href="#" title="products">
                                                <img class="primary_image" src="${path}/images/products/1.png" alt=""/>
                                            </a>
                                        </div>
                                        <div class="items" data-thumb='<img class="primary_image" src="${path}/images/Dana-home1-product2.jpg" alt=""/>'>
                                            <a href="#" title="products">
                            ...
                            <div class="product">
                                ...
                                <!-- End wrap-title -->
                                <a class="product-images" href="#" title="">
                                    <img class="primary_image" src="${path}/images/products/22.jpg" alt=""/>
                                </a>
                                <div class="action">
                                    <a href="#" class="refresh"><i class="zmdi zmdi-refresh-sync"></i></a>
                                    <a title="Like" href="#"><i class="zmdi zmdi-favorite-outline"></i></a>
                            ...
                            <div class="product">
                                ...
                                <!-- End wrap-title -->
                                <a class="product-images" href="#" title="">
                                    <img class="primary_image" src="${path}/images/products/16.jpg" alt=""/>
                                </a>
                                <div class="action">
                                    <a href="#" class="refresh"><i class="zmdi zmdi-refresh-sync"></i></a>
                                    <a title="Like" href="#"><i class="zmdi zmdi-favorite-outline"></i></a>
                            ...
                            <div class="product">
                                ...
                                <div class="product-images">
                                    <div class="slide-product-images">
                                        ...
                                        <div class="items" data-thumb='<img class="primary_image" src="${path}/images/products/2.jpg" alt=""/>'>
                                            <a href="#" title="products">
                                                <img class="primary_image" src="${path}/images/products/2.jpg" alt=""/>
                                            </a>
                                        </div>
                                        <div class="items" data-thumb='<img class="primary_image" src="${path}/images/products/3.jpg" alt=""/>'>
                                            <a href="#" title="products">
                                                <img class="primary_image" src="${path}/images/products/3.jpg" alt=""/>
                                            </a>
                                        </div>
                            ...
                            <div class="product">
                                ...
                                <div class="product-images">
                                    <div class="slide-product-images">
                                        ...
                                        <div class="items" data-thumb='<img class="primary_image" src="${path}/images/products/2.jpg" alt=""/>'>
                                            <a href="#" title="products">
                                                <img class="primary_image" src="${path}/images/products/8.jpg" alt=""/>
                                            </a>
                                        </div>
                                        <div class="items" data-thumb='<img class="primary_image" src="${path}/images/products/3.jpg" alt=""/>'>
                                            <a href="#" title="products">
                        ...
                        <div class="product">
                            ...
                            <div class="product-images">
                                <div class="slide-product-images">
                                    ...
                                    <div class="items" data-thumb='<img class="primary_image" src="${path}/images/products/12.jpg" alt=""/>'>
                                        <a href="#" title="products">
                                            <img class="primary_image" src="${path}/images/products/12.jpg" alt=""/>
                                        </a>
                                    </div>
                                    <div class="items" data-thumb='<img class="primary_image" src="${path}/images/products/13.jpg" alt=""/>'>
                                        <a href="#" title="products">
                ...
                <div id="tab1_04" class="tab-content1">
                    <div class="products">
                        <div class="product">
                            ...
                            <div class="product-images">
                                <div class="slide-product-images">
                                    <div class="items" data-thumb='<img class="primary_image" src="${path}/images/products/8.jpg" alt=""/>'>
                                        <a href="#" title="products">
                                            <img class="primary_image" src="${path}/images/products/8.jpg" alt=""/>
                                        </a>
                                    </div>
                                    ...
                                    <div class="items" data-thumb='<img class="primary_image" src="${path}/images/products/10.jpg" alt=""/>'>
                                        <a href="#" title="products">
                                            <img class="primary_image" src="${path}/images/products/10.jpg" alt=""/>
                                        </a>
                                    </div>
                                </div>
                            </div>
...
<div class="bottom-product-footer space-padding-tb-50">
    <div class="container">
        <div class="col-md-4 col-sm-4">
            ...
            <div class="product">
                <a class="product-images" href="#" title="">
                    <img class="primary_image" src="${path}/images/products/14.jpg" alt=""/>
                </a>
                <div class="product-content">
                    <a class="category" href="#" title="category">watch</a>
            ...
            <div class="product">
                <a class="product-images" href="#" title="">
                    <img class="primary_image" src="${path}/images/products/15.jpg" alt=""/>
                </a>
                <div class="product-content">
                    <a class="category" href="#" title="category">watch</a>
        ...
        <div class="col-md-4 col-sm-4">
            ...
            <div class="product">
                <a class="product-images" href="#" title="">
                    <img class="primary_image" src="${path}/images/products/17.jpg" alt=""/>
                </a>
                <div class="product-content">
                    <a class="category" href="#" title="category">watch</a>
            ...
            <div class="product">
                <a class="product-images" href="#" title="">
                    <img class="primary_image" src="${path}/images/products/18.jpg" alt=""/>
                </a>
                <div class="product-content">
                    <a class="category" href="#" title="category">watch</a>
        ...
        <div class="col-md-4 col-sm-4">
            ...
            <div class="product">
                <a class="product-images" href="#" title="">
                    <img class="primary_image" src="${path}/images/products/19.jpg" alt=""/>
                </a>
                <div class="product-content">
                    <a class="category" href="#" title="category">watch</a>
            ...
            <div class="product">
                <a class="product-images" href="#" title="">
                    <img class="primary_image" src="${path}/images/products/20.jpg" alt=""/>
                </a>
                <div class="product-content">
                    <a class="category" href="#" title="category">watch</a>
            ...
            <div class="product">
                <a class="product-images" href="#" title="">
                    <img class="primary_image" src="${path}/images/products/21.jpg" alt=""/>
                </a>
                <div class="product-content">
                    <a class="category" href="#" title="category">watch</a>
...
<div class="brand-container space-50">
    <div class="container">
        <div class="slider-brand">
            <div class="item">
                <a href="#" title="Brand">
                    <img src="${path}/images/Dama-brand1.jpg"  alt="Brand">
                </a>
            </div>
            <!-- End item -->
            <div class="item">
                <a href="#" title="Brand">
                    <img src="${path}/images/Dama-brand2.jpg"  alt="Brand">
                </a>
            </div>
            <!-- End item -->
            <div class="item">
                <a href="#" title="Brand">
                    <img src="${path}/images/Dama-brand3.jpg"  alt="Brand">
                </a>
            </div>
            <!-- End item -->
            <div class="item">
                <a href="#" title="Brand">
                    <img src="${path}/images/Dama-brand4.jpg" alt="Brand">
                </a>
            </div>
            <!-- End item -->
            <div class="item">
                <a href="#" title="Brand">
                    <img src="${path}/images/Dama-brand5.jpg" alt="Brand">
                </a>
            </div>
            <!-- End item -->
            <div class="item">
                <a href="#" title="Brand">
                    <img src="${path}/images/Dama-brand6.jpg" alt="Brand">
                </a>
            </div>
            <!-- End item -->
        </div>
